...
function ScalitaLogo() {
  return (
    <Link href="/" className="flex items-center gap-2.5 group">
      <img src="/logo.png" alt="SCALITA AI Logo" className="w-8 h-8 object-contain" />
...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-14 overflow-hidden">
      ...
      <div className="relative z-20 mx-auto max-w-6xl px-6 w-full py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        {/* Left — Text */}
...
const FEATURES = [
  ...
  },
  {
    ...
    tag: "02",
    desc: "SCALITA AI finds the key price-moving drivers from raw text — from earnings guidance to red-flag words buried in prospectuses.",
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center space-y-10">
        ...
        <FadeIn delay={0.25}>
          <p className="font-mono text-[10px] text-zinc-700 tracking-wider">
            ADVANCED AI ENGINE · NO SIGN-UP · INSTANT ANALYSIS
          </p>
        </FadeIn>
      </div>
    </section>
  ...
  return (
    <footer className="border-t border-zinc-900 py-8 px-6 bg-black">
      <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <ScalitaLogo />
        <p className="font-mono text-[10px] text-zinc-700 tracking-wider">
          © {new Date().getFullYear()} SCALITA AI · FOR INFORMATIONAL PURPOSES ONLY
        </p>
